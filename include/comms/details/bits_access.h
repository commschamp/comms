...
#define COMMS_AS_BITMASK_FUNC                                                  \
  FUNC_AUTO_REF_RETURN(asBitmask, decltype(comms::field::toFieldBase(*this)))
#define COMMS_AS_BITMASK_CONST_FUNC                                            \
  FUNC_AUTO_REF_RETURN_CONST(asBitmask,                                        \
...
#define COMMS_CHOOSE_BIT_ACC_FUNC_(N, f_, ...)                                 \
  COMMS_EXPAND(COMMS_BIT_ACC_FUNC_##N(f_, __VA_ARGS__))
#define COMMS_CHOOSE_BIT_ACC_FUNC(N, f_, ...)                                  \
  COMMS_EXPAND(COMMS_CHOOSE_BIT_ACC_FUNC_(N, f_, __VA_ARGS__))
#define COMMS_DO_BIT_ACC_FUNC(f_, ...)                                         \
  COMMS_EXPAND(                                                                \
      COMMS_CHOOSE_BIT_ACC_FUNC(COMMS_NUM_ARGS(__VA_ARGS__), f_, __VA_ARGS__))
