...
template <typename... TOptions> class FieldBase;
...
class FieldBase<comms::option::def::Endian<TEndian>, TOptions...>
...
class FieldBase<comms::option::def::VersionType<T>, TOptions...>
    : public FieldBase<TOptions...> {
protected:
  using VersionType = T;
};
...
class FieldBase<comms::option::app::EmptyOption, TOptions...>
    : public FieldBase<TOptions...> {};

template <typename... TTuple, typename... TOptions>
class FieldBase<std::tuple<TTuple...>, TOptions...>
