...
template <typename... TOptions> class MessageInterfaceOptionsParser;

template <> class MessageInterfaceOptionsParser<> {
public:
  ...
  static constexpr std::size_t VersionInExtraTransportFields =
      std::numeric_limits<std::size_t>::max();

  template <typename TBase = MessageInterfaceEmptyBase>
  using BuildEndian = TBase;

  template <typename TBase> using BuildMsgIdType = TBase;

  template <typename TBase> using BuildExtraTransportFields = TBase;

  template <typename TBase> using BuildVersionInExtraTransportFields = TBase;

  template <typename TBase> using BuildMsgIdInfo = TBase;

  template <typename TBase> using BuildReadBase = TBase;

  template <typename TBase> using BuildWriteBase = TBase;

  template <typename TBase> using BuildValid = TBase;

  template <typename TBase> using BuildLength = TBase;

  template <typename TBase> using BuildHandler = TBase;

  template <typename TBase> using BuildRefresh = TBase;

  template <typename TBase> using BuildName = TBase;
};

template <typename T, typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::def::MsgIdType<T>,
                                    TOptions...>
...
class MessageInterfaceOptionsParser<comms::option::app::IdInfoInterface,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
class MessageInterfaceOptionsParser<comms::option::def::Endian<TEndian>,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
class MessageInterfaceOptionsParser<comms::option::app::ReadIterator<TIter>,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
template <typename TIter, typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::WriteIterator<TIter>,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
template <typename T, typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::Handler<T>, TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
template <typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::ValidCheckInterface,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
  static constexpr bool HasValid = true;

  template <typename TBase> using BuildValid = MessageInterfaceValidBase<TBase>;
};

template <typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::LengthInfoInterface,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
template <typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::RefreshInterface,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
template <typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::NameInterface,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
  static constexpr bool HasName = true;

  template <typename TBase> using BuildName = MessageInterfaceNameBase<TBase>;
};

template <typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::NoVirtualDestructor,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
...
class MessageInterfaceOptionsParser<
    comms::option::def::ExtraTransportFields<TFields>, TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
  static_assert(comms::util::isTuple<TFields>(),
                "Template parameter to "
                "comms::option::def::ExtraTransportFields is expected to "
                "be std::tuple.");
...
public:
  ...
  template <typename TBase>
  using BuildExtraTransportFields =
      MessageInterfaceExtraTransportFieldsBase<TBase, ExtraTransportFields>;
};

template <std::size_t TIdx, typename... TOptions>
class MessageInterfaceOptionsParser<
    comms::option::def::VersionInExtraTransportFields<TIdx>, TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {
public:
  ...
  using BuildVersionInExtraTransportFields =
      MessageInterfaceVersionInExtraTransportFieldsBase<
          TBase, VersionInExtraTransportFields>;
};

template <typename... TOptions>
class MessageInterfaceOptionsParser<comms::option::app::EmptyOption,
                                    TOptions...>
    : public MessageInterfaceOptionsParser<TOptions...> {};

template <typename... TBundledOptions, typename... TOptions>
class MessageInterfaceOptionsParser<std::tuple<TBundledOptions...>, TOptions...>
