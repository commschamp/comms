...
/// @file
/// @brief Provides common base class for the custom messages with default
/// implementation.
...
///     diagram will look like: comms::Message <-- TMessage <--
///     comms::MessageBase.
/// @tparam TOptions Variadic template parameter that can include zero or more
///     options that specify behaviour. The options may be comma separated as
///     well as bundled into std::tuple. Supported options are:
///     @li @ref comms::option::def::StaticNumIdImpl - In case message have
///     numeric IDs
...
///     @li @ref comms::option::def::NoIdImpl - Some message may not have valid
///     IDs and
...
///         default constructed value of comms::Message::MsgIdType will be
///         returned.
///     @li @ref comms::option::def::MsgType - Provide type of actual message
///     that
///         inherits from this comms::MessageBase class.
///     @li @ref comms::option::def::FieldsImpl - Usually implementation of
///     read, write,
///         validity check, and length calculation is pretty straight forward.
///         For example the message is considered valid if all the field values
///         are considered to be valid, or read operation is to perform read for
///         all the fields in the message. If the @ref
///         comms::option::def::FieldsImpl option with all the message field
///         classes bundled into the std::tuple is provided, then @ref
///         MessageBase class can implement readImpl(), writeImpl(),
///         validImpl(), lengthImpl() virtual functions declared as pure in
///         comms::Message interface. The option also provides an accessor
///         functions to the all the field objects: fields().
///     @li @ref comms::option::def::ZeroFieldsImpl - This option is an alias to
///         @ref comms::option::def::FieldsImpl<std::tuple<> >, which provides
///         implementation readImpl(), writeImpl(), validImpl(), lengthImpl()
///         virtual functions when message contains no fields, i.e. readImpl()
///         and writeImple() will always report success doing nothing,
///         validImpl() will always return true, and lengthImpl() will always
///         return 0.
///     @li @ref comms::option::def::HasCustomRefresh - Notify @ref
///     comms::MessageBase that
///             there is custom doRefresh() member function in the message
///             definition class.
///     @li @ref comms::option::def::HasDoGetId - Enable implementation of
///     getIdImpl() even if
///         @ref comms::option::def::StaticNumIdImpl option wasn't used. Must be
///         paired with
///         @ref comms::option::def::MsgType.
///     @li @ref comms::option::def::HasName - Notify @ref comms::MessageBase
///     that
///             there is custom doName() member function in the message
///             definition class.
///     @li @ref comms::option::def::FailOnInvalid - Fail the read operation if
///     the contents are invalid.
///     @li @ref comms::option::app::NoReadImpl - Inhibit the implementation of
///     readImpl().
///     @li @ref comms::option::app::NoWriteImpl - Inhibit the implementation of
///     writeImpl().
///     @li @ref comms::option::app::NoLengthImpl - Inhibit the implementation
///     of lengthImpl().
///     @li @ref comms::option::app::NoValidImpl - Inhibit the implementation of
///     validImpl().
///     @li @ref comms::option::app::NoDispatchImpl - Inhibit the implementation
///     of dispatchImpl().
/// @extends Message
...
public:
  ...
  /// @brief Compile type inquiry whether static numeric id has been provided
  /// via
  ///     @ref comms::option::def::StaticNumIdImpl.
  static constexpr bool hasStaticMsgId() { return ImplOptions::HasStaticMsgId; }
  ...
  static constexpr std::intmax_t staticMsgId() { return ImplOptions::MsgId; }

  /// @brief Compile type inquiry whether fields have been provided via
  ///     @ref comms::option::def::FieldsImpl.
  static constexpr bool hasFields() { return ImplOptions::HasFieldsImpl; }
  ...
  static constexpr bool hasMsgType() { return ImplOptions::HasMsgType; }
  ...
  /// @brief Compile time inquiry of whether polymoriphic validity check has
  /// been
  ///     requested via interface options and hasn't been inhibited by
  ...
  static constexpr bool hasCustomName() { return ImplOptions::HasName; }

  /// @brief Compile type inquiry whether the class provides @ref doGetId()
  /// member function.
  ...
  /// @brief All field classes provided with @ref comms::option::def::FieldsImpl
  /// option.
  /// @details The type is not defined if @ref comms::option::def::FieldsImpl
  /// option
  ...
  /// @details The function doesn't exist if @ref comms::option::def::FieldsImpl
  /// option
  ///     wasn't provided to comms::MessageBase.
  ...
  /// @details This function exists only if @ref
  /// comms::option::def::StaticNumIdImpl option
  ...
  /// @details This function exists only if @ref comms::option::def::FieldsImpl
  /// option
  ///     was provided to comms::MessageBase. @n
  ...
  ///     If any field doesn't report ErrorStatus::Success, then read operation
  ...
  template <typename TIter> ErrorStatus doRead(TIter &iter, std::size_t size);
  ...
  ///     field object listed with @ref comms::option::def::FieldsImpl option.
  ///     If any field doesn't report ErrorStatus::Success, then write operation
  ///     stops, i.e. the provided iterator is not advanced any more.
  ...
  /// @details This function exists only if @ref comms::option::def::FieldsImpl
  /// or
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. To make this function works, every field class
  ///     must provide "valid()" function with following signature:
  ///     @code
  ///     bool valid() const;
  ///     @endcode
  ...
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. To make this function works, every field class
  ///     must provide "refresh()" function with following signature:
  ///     @code
  ///     bool refresh() const;
  ///     @endcode
  ///     This function will invoke such "refresh()" member function for every
  ///     field object listed with @ref comms::option::def::FieldsImpl option
  ///     and will return @b true if <b>at least</b> one of the invoked
  ///     functions returned
  ///     @b true.
  ...
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. To make this function works, every field class
  ///     must provide "length()" function with following signature:
  ///     @code
  ///     std::size_t length() const;
  ///     @endcode
  ///     This function will invoke such "length()" member function for every
  ///     field object listed with @ref comms::option::def::FieldsImpl option.
  ///     The final result is a summary of the "length" values of all the
  ///     fields.
  /// @return Serialisation length of the message.
  std::size_t doLength() const;

  /// @brief Default implementation of partial length calculation functionality.
  /// @details Similar to @ref length() member function but starts the
  /// calculation
  ///     at the the field specified using @b TFromIdx template parameter.
  /// @tparam TFromIdx Index of the field, from which length calculation will
  /// start
  /// @return Calculated serialisation length
  /// @pre TFromIdx < std::tuple_size<AllFields>::value
  template <std::size_t TFromIdx> std::size_t doLengthFrom() const;

  /// @brief Default implementation of partial length calculation functionality.
  /// @details Similar to @ref length() member function but stops the
  /// calculation
  ...
  template <std::size_t TUntilIdx> std::size_t doLengthUntil() const;
  ...
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. To make this function works, every field class
  ///     must provide "minLength()" function with following signature:
  ///     @code
  ...
  /// @details Similar to @ref doMinLength() member function but starts the
  /// calculation
  ///     at the the field specified using @b TFromIdx template parameter.
  /// @tparam TFromIdx Index of the field, from which length calculation will
  /// start
  ...
  /// @brief Compile time constant of minimal partial serialisation length.
  /// @details Similar to @ref doMinLength() member function but stops the
  /// calculation
  ///     at the the field specified using @b TUntilIdx template parameter.
  /// @tparam TUntilIdx Index of the field, at which the calculation will stop.
  ///     The length of the filed with index @b TUntilIdx will @b NOT be taken
  ...
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. To make this function works, every field class
  ///     must provide "maxLength()" function with following signature:
  ///     @code
  ...
  /// @details Similar to @ref doMaxLength() member function but starts the
  /// calculation
  ///     at the the field specified using @b TFromIdx template parameter.
  /// @tparam TFromIdx Index of the field, from which length calculation will
  /// start
  ...
  /// @brief Compile time constant of maximal partial serialisation length.
  /// @details Similar to @ref doMaxLength() member function but stops the
  /// calculation
  ///     at the the field specified using @b TUntilIdx template parameter.
  /// @tparam TUntilIdx Index of the field, at which the calculation will stop.
  ///     The length of the filed with index @b TUntilIdx will @b NOT be taken
  ...
  /// @details This function exists only if @ref comms::option::def::FieldsImpl
  /// or
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to @ref
  ///     comms::MessageBase and
  ///     @ref comms::option::def::VersionInExtraTransportFields was provided to
  ///     the message interface class (@ref comms::Message). @n This function
  ///     will invoke such @b setVersion() member function for every field
  ///     object listed with @ref comms::option::def::FieldsImpl option and will
  ///     return @b true if <b>at least</b> one of the invoked functions
  ///     returned
...
protected:
  ...
  ///     @ref comms::option::def::MsgIdType option and the polymorphic ID
  ///     retrieval functionality was requested (using @ref
  ///     comms::option::app::IdInfoInterface). In addition to the conditions
  ///     listed earlier this function is provided if local doGetId() function
  ///     was generated. If not, it may still be provided if the derived class
  ///     is known (@ref comms::option::def::MsgType option was used) and the
  ///     @ref comms::option::def::HasDoGetId option is used to declare the
  ///     derived type having doGetId() member function defined.
  /// @return ID value passed as template parameter to @ref
  /// comms::option::def::StaticNumIdImpl
  ///     option.
  virtual MsgIdParamType getIdImpl() const override;

  /// @brief Implementation of dispatch functionality.
  /// @details This function exists only if the following conditions are @b
  /// true:
  ///     @li @ref comms::option::app::Handler option
  ///     option was provided to comms::Message.
  ///     @li @ref comms::option::def::MsgType option was used to specify actual
  ///     type of the inheriting message class.
  ...
  ///     implement "handle()" member function for every message type (specified
  ///     as Message1, Message2, ...) it is supposed to handle:
  ///     @code
  ///     class MyHandler {
  ///     public:
  ...
  ///     messages.
  ///
  ///     Once the requirements above are properly implemented, the
  ///     implementation of this message is very simple:
  ///     @code
  ...
  ///     function in the Handler class, based on the actual type of the
  ///     message. If such function is not found, the compiler will choose to
  ///     call the one that covers all possible messages @b "void
  ///     handle(MessageBase& msg)".
  ...
  /// @details This function exists if @ref comms::option::app::ReadIterator
  /// option
  ///         was provided to comms::Message class when specifying interface,
  ///         and
  ///         @ref comms::option::app::NoReadImpl option was @b NOT used to
  ///         inhibit the implementation. @n If @ref comms::option::def::MsgType
  ///         option was used to specify the actual type of the message, and if
  ///         it contains custom doRead() function, it will be invoked.
  ///         Otherwise, the invocation of comms::MessageBase::doRead() will be
  ///         chosen in case fields were specified using @ref
  ///         comms::option::def::FieldsImpl option.
  /// @param[in, out] iter Iterator used for reading the data.
  /// @param[in] size Maximum number of bytes that can be read.
  /// @return Status of the operation.
  ...
  ///     function provides an ability to read all the fields up to (not
  ///     including) requested field. The overriding doRead() function in the
  ...
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. The requirements from field classes is the same as
  ///     explained in doRead() documentation.
  ...
  ///     @ref doReadUntil() function allows to read fields up to a specified
  ///     one, while this function provides an ability to resume reading from
  ///     some other field in the middle. The overriding doRead() function in
  ///     the custom message definition class may use this function for such
  ///     task. This function exists only if @ref comms::option::def::FieldsImpl
  ///     or
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. The requirements from field classes is the same as
  ///     explained in doRead() documentation.
  ...
  /// @tparam TUntilIdx Zero based index of the field to read until (not
  /// included).
  /// @tparam TIter Type of the iterator used for reading.
  /// @param[in, out] iter Iterator used for reading the data.
  /// @param[in] len Maximum number of bytes that can be read.
  ...
  /// @details This function exists if @ref comms::option::app::WriteIterator
  /// option
  ///         was provided to comms::Message class when specifying interface,
  ///         and
  ///         @ref comms::option::app::NoWriteImpl option was @b NOT used to
  ///         inhibit the implementation. @n If @ref comms::option::def::MsgType
  ///         option was used to specify the actual type of the message, and if
  ///         it contains custom doWrite() function, it will be invoked.
  ///         Otherwise, the invocation of comms::MessageBase::doWrite() will be
  ///         chosen in case fields were specified using @ref
  ///         comms::option::def::FieldsImpl option.
  /// @param[in, out] iter Iterator used for writing the data.
  /// @param[in] size Maximum number of bytes that can be written.
  /// @return Status of the operation.
  virtual ErrorStatus writeImpl(WriteIterator &iter,
  ...
  ///     @ref comms::option::def::ZeroFieldsImpl option was provided to
  ///     comms::MessageBase. The requirements from field classes is the same as
  ///     explained in doWrite() documentation.
  ...
  /// @tparam TUntilIdx Zero based index of the field to write until (not
  /// including).
  /// @tparam TIter Type of iterator used for writing.
  /// @param[in, out] iter Iterator used for writing the data.
  /// @param[in] len Maximum number of bytes that can be written.
  ...
  /// @details This function exists if @ref
  /// comms::option::app::ValidCheckInterface option
  ///         was provided to comms::Message class when specifying interface,
  ///         and
  ///         @ref comms::option::app::NoValidImpl option was @b NOT used to
  ///         inhibit the implementation. @n If @ref comms::option::def::MsgType
  ///         option was used to specify the actual type of the message, and if
  ///         it contains custom doValid() function, it will be invoked.
  ///         Otherwise, the invocation of comms::MessageBase::doValid() will be
  ///         chosen in case fields were specified using @ref
  ///         comms::option::def::FieldsImpl option.
  ...
  /// @details This function exists if @ref
  /// comms::option::app::LengthInfoInterface option
  ///         was provided to comms::Message class when specifying interface,
  ///         and
  ///         @ref comms::option::app::NoLengthImpl option was @b NOT used to
  ///         inhibit the implementation. @n If @ref comms::option::def::MsgType
  ///         option was used to specify the actual type of the message, and if
  ///         it contains custom doLength() function, it will be invoked.
  ///         Otherwise, the invocation of comms::MessageBase::doLength() will
  ///         be chosen in case fields were specified using @ref
  ///         comms::option::def::FieldsImpl option.
  /// @return Serialisation length of the message.
  virtual std::size_t lengthImpl() const override;

  /// @brief Implementation of polymorphic refresh functionality.
  /// @details This function exists if @ref comms::option::app::RefreshInterface
  /// option
  ///         was provided to comms::Message class when specifying interface,
  ///         and @ref comms::option::def::HasCustomRefresh option was used
  ///         (either on on of the fields or when defining a message class) to
  ///         to notify about existence of custom refresh functionality.
  ///         If @ref comms::option::def::MsgType option was used to specify the
  ///         actual message class, the @b this pointer will be downcasted to it
  ///         to invoke doRefresh() member function defined there. If such is
  ///         not defined the default doRefresh() member function from this
  ///         class will be used.
  /// @return @b true in case fields were updated, @b false if nothing has
  /// changed.
  virtual bool refreshImpl() override;

  /// @brief Implementation of polymorphic name retrieval functionality.
  /// @details This function exists if @ref comms::option::app::NameInterface
  /// option
  ///         was provided to @ref comms::Message class when specifying
  ///         interface, and @ref comms::option::def::HasName as well as @ref
  ///         comms::option::def::MsgType options ware used for this class. This
  ///         function downcasts @b this pointer to actual message type and
...
/// @brief Upcast type of the message object to comms::MessageBase in order to
/// have
///     access to its internal types.
template <typename TMessage, typename... TOptions>
inline MessageBase<TMessage, TOptions...> &
toMessageBase(MessageBase<TMessage, TOptions...> &msg) {
  return msg;
}
...
///     access to its internal types.
template <typename TMessage, typename... TOptions>
inline const MessageBase<TMessage, TOptions...> &
toMessageBase(const MessageBase<TMessage, TOptions...> &msg) {
  return msg;
}
...
///     type.
template <typename T> constexpr bool isMessageBase() {
...
///     require definition of @b Base inner member type (for some compilers) and
///     does @b NOT define inner @b Field_* types for used fields.
...
#define COMMS_MSG_FIELDS_ACCESS(...)                                           \
  ...
  COMMS_MSG_FIELDS_ACCESS_FUNC {                                               \
    ...
    static_assert(std::tuple_size<AllFieldsTuple>::value ==                    \
...
///     @ref comms::MessageBase::fields() member function(s). The fields are
///     bundled into <a
///     href="http://en.cppreference.com/w/cpp/utility/tuple">std::tuple</a> and
///     can be accessed using indices with <a
///     href="http://en.cppreference.com/w/cpp/utility/tuple/get">std::get</a>.
///     For convenience, the fields should be named. The
///     COMMS_MSG_FIELDS_NAMES() macro does exactly that. @n As an example,
///     let's assume that custom message uses 3 fields of any types:
///     @code
...
///
///     The usage of the COMMS_MSG_FIELDS_NAMES() macro with the list of the
///     field's names is equivalent to having the following definitions inside
///     the message class
///     @code
...
///         };
///
///         static_assert(std::tuple_size<Base::AllFields>::value ==
///         FieldIdx_nameOfValues,
///             "Number of expected fields is incorrect");
///
///         // Accessor to "name1" field.
///         auto field_name1() ->
///         decltype(std::get<FieldIdx_name1>(Base::fields()))
///         {
///             return std::get<FieldIdx_name1>(Base::fields());
///         }
///
///         // Accessor to "name1" field.
///         auto field_name1() const ->
///         decltype(std::get<FieldIdx_name1>(Base::fields()))
///         {
///             return std::get<FieldIdx_name1>(Base::fields());
///         }
...
///         auto field_name2() ->
///         decltype(std::get<FieldIdx_name2>(Base::fields()))
///         {
///             return std::get<FieldIdx_name2>(Base::fields());
///         }
///
///         // Accessor to "name2" field.
///         auto field_name2() const ->
///         decltype(std::get<FieldIdx_name2>(Base::fields()))
///         {
///             return std::get<FieldIdx_name2>(Base::fields());
///         }
...
///         auto field_name3() ->
///         decltype(std::get<FieldIdx_name3>(Base::fields()))
///         {
///             return std::get<FieldIdx_name3>(Base::fields());
///         }
///
///         // Accessor to "name3" field.
///         auto field_name3() const ->
///         decltype(std::get<FieldIdx_name3>(Base::fields()))
///         {
///             return std::get<FieldIdx_name3>(Base::fields());
///         }
...
#define COMMS_MSG_FIELDS_NAMES(...)                                            \
  ...
  COMMS_EXPAND(COMMS_DO_FIELD_TYPEDEF(typename Base::AllFields, Field_,        \
                                      FieldIdx_, __VA_ARGS__))
...
///     @ref COMMS_MSG_FIELD_ALIAS_ACCESS() to define convenience access
///     functions.
/// @related comms::MessageBase
/// @note Defined in "comms/MessageBase.h"
...
/// @brief Generate convinience alias types and access member functions for
/// other
///     member fields.
/// @details The #COMMS_MSG_FIELDS_NAMES() macro generates inner types
///     and convenience access member functions for member fields. Sometimes the
///     fields may get renamed or moved to be a member of other fields, like
...
///     to other fields. For example, let's assume that some message class was
///     defined: like this.
///     @code
///     class Message1 : public comms::MessageBase<...>
///     {
...
///
///         auto field_name3() const ->
///         decltype(field_newName3().field_member1())
///         {
///             return field_newName3().field_member1();
///         }
///     };
