...
template <typename TResult, TResult TPoly, TResult TInit = 0, TResult TFin = 0,
          bool TReflect = false, bool TReflectRem = false>
using Crc = comms::frame::checksum::Crc<TResult, TPoly, TInit, TFin, TReflect,
                                        TReflectRem>;
