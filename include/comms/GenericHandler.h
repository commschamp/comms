...
///          your handler from comms::GenericHandler and override the
...
class GenericHandler {
  static_assert(util::IsTuple<TAll>::Value, "TAll must be std::tuple");
...
protected:
  ...
  ///     virtual. The protected destructor prevents typedef of @ref
  ///     GenericHandler and use it as actual handler class. To allow
  ///     polymorphic delete (destruction) make sure to declare the inherited
...
/// @cond SKIP_DOC
template <typename TDefault, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename T7, typename T8, typename T9,
          typename T10, typename... TRest, typename TRetType>
class GenericHandler<
    TDefault, std::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TRest...>,
    TRetType>
...
template <typename TDefault, typename TRetType> class GenericHandlerBase {
public:
  using RetType = TRetType;
  ...
  virtual TRetType handle(TDefault &msg) {
    ...
    using Tag = typename comms::util::LazyShallowConditional<
        std::is_void<TRetType>::value>::template Type<VoidReturnTag,
...
private:
  ...
  template <typename... TParams>
  using RetValueShallowCondWrap = typename comms::util::LazyShallowConditional<
      std::is_lvalue_reference<TRetType>::value>::
      template Type<ReferenceReturnTag, ValueReturnTag, TParams...>;
...
class GenericHandler<TDefault, std::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>,
                     TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
...
template <typename TDefault, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename T7, typename T8, typename TRetType>
...
template <typename TDefault, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename T7, typename TRetType>
class GenericHandler<TDefault, std::tuple<T1, T2, T3, T4, T5, T6, T7>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
...
template <typename TDefault, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename TRetType>
class GenericHandler<TDefault, std::tuple<T1, T2, T3, T4, T5, T6>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
...
template <typename TDefault, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename TRetType>
class GenericHandler<TDefault, std::tuple<T1, T2, T3, T4, T5>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
...
template <typename TDefault, typename T1, typename T2, typename T3, typename T4,
          typename TRetType>
class GenericHandler<TDefault, std::tuple<T1, T2, T3, T4>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
...
template <typename TDefault, typename T1, typename T2, typename T3,
          typename TRetType>
class GenericHandler<TDefault, std::tuple<T1, T2, T3>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
...
class GenericHandler<TDefault, std::tuple<T1, T2>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
...
class GenericHandler<TDefault, std::tuple<T1>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
...
class GenericHandler<TDefault, std::tuple<>, TRetType>
    : public details::GenericHandlerBase<TDefault, TRetType> {
  using BaseImpl = details::GenericHandlerBase<TDefault, TRetType>;
