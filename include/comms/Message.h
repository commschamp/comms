...
/// @file
/// @brief Contains definition of Message object interface and various base
/// classes for custom messages.
...
///     @li @ref comms::option::def::BigEndian or @ref
///     comms::option::def::LittleEndian - options
...
///     @li @ref comms::option::def::MsgIdType - an option used to specify type
///     of the ID
///         value used to identify the message. If this option is used,
///         the @ref MsgIdType and
///         @ref MsgIdParamType types get defined.
///     @li @ref comms::option::def::ExtraTransportFields - Provide extra fields
///     that
///         are read / written by transport layers, but may influence the way
///         the message being serialized / deserialized and/or handled.
///     @li @ref comms::option::def::VersionInExtraTransportFields - Provide
///     index of
///         the version field in extra transport fields.
///     @li @ref comms::option::app::IdInfoInterface - an option used to provide
///     polymorphic
///         id retrieval functionality. If this option is used in conjunction
///         with comms::option::MsgIdType, the getId() member function is
///         defined.
///     @li @ref comms::option::app::ReadIterator - an option used to specify
///     type of iterator
///         used for reading. If this option is not used, then @ref read()
///         member function doesn't exist.
///     @li @ref comms::option::app::WriteIterator - an option used to specify
///     type of iterator
///         used for writing. If this option is not used, then @ref write()
///         member function doesn't exist.
///     @li @ref comms::option::app::ValidCheckInterface - an option used to add
///     @ref valid()
///         member function to the default interface.
///     @li @ref comms::option::app::LengthInfoInterface - an option used to add
///     @ref length()
///         member function to the default interface.
///     @li @ref comms::option::app::RefreshInterface - an option used to add
///     @ref refresh()
///         member function to the default interface.
///     @li @ref comms::option::app::NameInterface - an option used to add @ref
///     name()
///         member function to the default interface.
///     @li @ref comms::option::app::Handler - an option used to specify type of
///     message handler
...
///     @li @ref comms::option::app::NoVirtualDestructor - Force the destructor
///     to be
...
public:
  ...
  ///     any polymorphic behavior, i.e. if there is at least one virtual
  ///     function. It is possible to explicitly suppress @b virtual declaration
  ///     by using comms::option::app::NoVirtualDestructor option.
  ~Message() noexcept = default;

  /// @brief Compile type inquiry whether message interface class defines @ref
  /// MsgIdType
  ...
  /// Endian
  ///     and @ref Field types.
  static constexpr bool hasEndian() { return InterfaceOptions::HasEndian; }
  ...
  ///     ReadIterator type.
  static constexpr bool hasRead() { return InterfaceOptions::HasReadIterator; }
  ...
  static constexpr bool hasValid() { return InterfaceOptions::HasValid; }

  /// @brief Compile type inquiry whether message interface class defines
  ///     @ref length() and @ref lengthImpl() member functions.
  static constexpr bool hasLength() { return InterfaceOptions::HasLength; }

  /// @brief Compile type inquiry whether message interface class defines
  ///     @ref refresh() and @ref refreshImpl() member functions.
  static constexpr bool hasRefresh() { return InterfaceOptions::HasRefresh; }

  /// @brief Compile type inquiry whether message interface class defines
  ///     @ref dispatch() and @ref dispatchImpl() member functions as well as
  ///     @ref Handler and @ref DispatchRetType types.
  static constexpr bool hasDispatch() { return InterfaceOptions::HasHandler; }
  ...
  ///     hasn't been used, the @b std::numeric_limits<std::size_t>::max() is
  ///     returned.
  ...
  static constexpr bool hasName() { return InterfaceOptions::HasName; }
  ...
  /// @brief Type used for message ID passed as parameter or returned from
  /// function.
  ...
  ///     only if @ref comms::option::def::MsgIdType option was used to specify
  ///     type of the ID value and @ref comms::option::app::IdInfoInterface
  ///     option are used.
  ...
  /// @details The type exists only if @ref comms::option::app::ReadIterator
  /// option
  ...
  /// @details The function exists only if @ref comms::option::app::ReadIterator
  /// option
  ///     was provided to comms::Message to specify type of the @ref
  ///     ReadIterator. The contents of the message are updated with bytes being
  ///     read. The buffer is external and maintained by the caller. The
  ///     provided iterator is advanced. The function invokes virtual readImpl()
  ///     function.
  ...
  ///     sequence of bytes stored somewhere.
  /// @details The type exists only if @ref comms::option::app::WriteIterator
  /// option
  ///     was provided to comms::Message to specify one.
  /// @see @ref hasWrite()
  ...
  /// @details The function exists only if @ref
  /// comms::option::app::WriteIterator option
  ///     was provided to comms::Message to specify type of the @ref
  ///     WriteIterator. The contents of the message are serialised into buffer.
  ///     The buffer is external and is maintained by the caller. The provided
  ///     iterator is advanced. The function invokes virtual writeImpl()
  ///     function.
  ...
  ///     I/O link . @n
  ///     The function exists only if @ref comms::option::app::RefreshInterface
  ///     option was provided to comms::Message. The function invokes virtual
  ...
  /// @details The function exists only if @ref
  /// comms::option::app::NameInterface option
  ///     was provided to comms::Message. The function invokes virtual
  ...
  /// @details The function exists only if @ref comms::option::app::Handler
  /// option
  ...
  /// @details The type exists only if @ref
  ...
  /// comms::option::def::ExtraTransportFields
  ///     option has been provided to @ref comms::Message class to specify them.
  ////    Some protocols may use additional values in transport information,
  ///such
  ...
  ///     of message payload. Their values are expected to be set by transport
  ///     layer(s) when such information is read. The transport layers are also
  ///     responsible to take the updated information from the relevant field
  ///     and write it when message contents being written.
  /// @see @ref hasTransportFields()
...
protected:
  ...
  ///     only if @ref comms::option::def::MsgIdType option was used to specify
  ///     type of the ID value as well as @ref
  ...
  ///     The function exists only if @ref comms::option::app::ReadIterator
  ///     option was provided to comms::Message to specify type of the @ref
  ///     ReadIterator.
  /// @param[in, out] iter Iterator used for reading the data.
  /// @param[in] size Maximum number of bytes that can be read.
  ...
  ///     The function exists only if @ref comms::option::app::WriteIterator
  ///     option was provided to comms::Message to specify type of the @ref
  ///     WriteIterator.
  /// @param[in, out] iter Iterator used for writing the data.
  /// @param[in] size Maximum number of bytes that can be written.
  ...
  ///     comms::ErrorStatus::NotSupported.
  /// @see @ref hasWrite()
  virtual comms::ErrorStatus writeImpl(WriteIterator &iter,
  ...
  ///     The function exists only if @ref
  ///     comms::option::app::ValidCheckInterface option was provided to
  ///     comms::Message.
  ...
  ///     The function exists only if @ref
  ///     comms::option::app::LengthInfoInterface option was provided to
  ///     comms::Message.
  ...
  ///     The function exists only if @ref comms::option::app::Handler option
  ///     was provided to comms::Message to specify type of the handler. If not
  ...
  ///     The function exists only if @ref comms::option::app::NameInterface
  ///     option was provided to @ref comms::Message.
  virtual const char *nameImpl() const = 0;

  /// @brief Write data into the output area.
  /// @details Use this function to write data to the output area using
  ///     provided iterator. This function requires knowledge about
  ///     serialisation endian. It exists only if endian type was specified
  ///     using @ref comms::option::def::BigEndian or @ref
  ///     comms::option::def::LittleEndian options to the class.
  ...
  template <typename T, typename TIter> static T readData(TIter &iter);
...
template <typename... TOptions>
inline Message<TOptions...> &toMessage(Message<TOptions...> &msg) {
  return msg;
}
...
///     access to its internal types.
template <typename... TOptions>
inline const Message<TOptions...> &toMessage(const Message<TOptions...> &msg) {
  return msg;
}
...
///     type.
template <typename T> constexpr bool isMessage() {
...
///     is reported.
/// @tparam TMsg Message interface class (extended or typedef-ed @ref
/// comms::Message)
...
using MessageIdType = typename comms::util::
    LazyDeepConditional<TMsg::InterfaceOptions::HasMsgIdType>::template Type<
        comms::details::MessageIdTypeRetriever, comms::util::AliasType,
        TDefaultType, TMsg>;
} // namespace comms

/// @brief Add convenience access enum and functions to extra transport fields.
/// @details Very similar to #COMMS_MSG_TRANSPORT_FIELDS_NAMES(), but does @b
/// NOT
///     require definition of @b Base inner member type (for some compilers) and
///     does @b NOT define inner @b TransportField_* types for used fields.
...
#define COMMS_MSG_TRANSPORT_FIELDS_ACCESS(...)                                 \
  ...
  COMMS_EXPAND(COMMS_DO_TRANSPORT_FIELD_ACC_FUNC(                              \
      TransportFields, transportFields(), __VA_ARGS__))

/// @brief Provide names for extra transport fields.
/// @details The comms::Message class provides access to its extra transport
/// fields via
///     comms::MessageBase::transportFields() member function(s). The fields are
///     bundled into <a
...
///     COMMS_MSG_TRANSPORT_FIELDS_NAMES() macro does exactly that. @n As an
///     example, let's assume that custom message uses 3 fields of any types:
///     @code
///     using TransportField1 = ...;
///     using TransportField2 = ...;
///     using TransportField3 = ...;
///
///     typedef std::tuple<TransportField1, TransportField2, TransportField3>
///     MyExtraTransportFields
///
...
///     };
///     @endcode
///     The usage of the COMMS_MSG_TRANSPORT_FIELDS_NAMES() macro with the list
///     of the extra transport field's names is equivalent to having the
///     following definitions inside the message class
///     @code
...
///         };
///
///         static_assert(std::tuple_size<Base::TransportFields>::value ==
///         TransportFieldIdx_nameOfValues,
///             "Number of expected transport fields is incorrect");
///
///         // Accessor to "name1" transport field.
///         auto transportField_name1() ->
///         decltype(std::get<TransportFieldIdx_name1>(Base::transportFields()))
///         {
///             return
///             std::get<TransportFieldIdx_name1>(Base::transportFields());
///         }
///
///         // Accessor to "name1" field.
///         auto transportField_name1() const ->
///         decltype(std::get<TransportFieldIdx_name1>(Base::transportFields()))
///         {
///             return
///             std::get<TransportFieldIdx_name1>(Base::transportFields());
...
///         auto transportField_name2() ->
///         decltype(std::get<TransportFieldIdx_name2>(Base::transportFields()))
///         {
///             return
///             std::get<TransportFieldIdx_name2>(Base::transportFields());
///         }
///
///         // Accessor to "name2" field.
///         auto transportField_name2() const ->
///         decltype(std::get<TransportFieldIdx_name2>(Base::transportFields()))
///         {
///             return
///             std::get<TransportFieldIdx_name2>(Base::transportFields());
...
///         auto transportField_name3() ->
///         decltype(std::get<TransportFieldIdx_name3>(Base::transportFields()))
///         {
///             return
///             std::get<TransportFieldIdx_name3>(Base::transportFields());
///         }
///
///         // Accessor to "name3" field.
///         auto transportField_name3() const ->
///         decltype(std::get<FieldIdx_name3>(Base::transportFields()))
///         {
...
///     @li @b TransportFieldIdx enum. The names are prefixed with @b
///     TransportFieldIdx_. The
///         @b TransportFieldIdx_nameOfValues value is automatically added at
///         the end.
///     @li Accessor functions prefixed with @b transportField_*
///     @li Types of fields prefixed with @b TransportField_*
///
///     As the result, the fields can be accessed using @b TransportFieldIdx
///     enum
///     @code
...
///         auto& field1 =
///         std::get<Message1::TransportFieldIdx_name1>(transportFields); auto&
///         field2 =
///         std::get<Message1::TransportFieldIdx_name2>(transportFields); auto&
///         field3 =
///         std::get<Message1::TransportFieldIdx_name3>(transportFields);
///
...
#define COMMS_MSG_TRANSPORT_FIELDS_NAMES(...)                                  \
  ...
  COMMS_EXPAND(COMMS_DO_FIELD_TYPEDEF(typename Base::TransportFields,          \
                                      TransportField_, TransportFieldIdx_,     \
                                      __VA_ARGS__))

/// @brief Generate convinience alias access member functions for extra
///     member transport fields.
/// @details Similar to @ref COMMS_MSG_TRANSPORT_FIELD_ALIAS() but requires
/// usage
///     of @ref COMMS_MSG_TRANSPORT_FIELDS_ACCESS() instead of
///     #COMMS_MSG_TRANSPORT_FIELDS_NAMES() and does NOT create alias to the
///     field type, only access functions.
/// @param[in] f_ Alias field name.
/// @param[in] ... List of fields' names.
/// @pre The macro @ref COMMS_MSG_TRANSPORT_FIELDS_ACCESS() needs to be used
/// before
///     @ref COMMS_MSG_TRANSPORT_FIELD_ALIAS_ACCESS() to define convenience
///     access functions.
/// @related comms::Message
...
///     the @ref COMMS_MSG_TRANSPORT_FIELD_ALIAS() macro can be used to create
///     alias to other fields. For example, let's assume that some common
///     interface class was defined: like this.
///     @code
///     class MyInterface : public comms::Message<...>
///     {
...
///
///         auto transportField_name3() const ->
///         decltype(transportField_newName3())
///         {
///             return transportField_newName3();
///         }
///     };
...
///
///         auto transportField_name3() ->
///         decltype(transportField_newName3().field_member1())
///         {
...
///     @ref COMMS_MSG_TRANSPORT_FIELD_ALIAS() to define convenience access
///     functions.
/// @related comms::Message
/// @see @ref COMMS_MSG_TRANSPORT_FIELD_ALIAS_ACCESS_NOTEMPLATE()
...
#define COMMS_MSG_TRANSPORT_FIELD_ALIAS_NOTEMPLATE(f_, ...)                    \
  COMMS_EXPAND(                                                                \
      COMMS_MSG_TRANSPORT_FIELD_ALIAS_ACCESS_NOTEMPLATE(f_, __VA_ARGS__))      \
  COMMS_EXPAND(COMMS_DO_ALIAS_TYPEDEF(TransportField_, f_, __VA_ARGS__))
