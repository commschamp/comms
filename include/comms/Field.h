...
///     @li comms::option::def::BigEndian or comms::option::def::LittleEndian -
///     Option to
...
public:
  ...
  /// @return Always @b false.
  static constexpr bool isVersionDependent() { return false; }

  /// @brief Default check of whether the field has defines refresh
  /// functionality
  /// @return Always @b false.
  static constexpr bool hasNonDefaultRefresh() { return false; }

  /// @brief Default check of whether the field has @b readNoStatus() member
  /// function
  /// @return Always @b true.
  static constexpr bool hasReadNoStatus() { return true; }

  /// @brief Default check of whether the field has @b writeNoStatus() member
  /// function
  /// @return Always @b true.
  static constexpr bool hasWriteNoStatus() { return true; }

  /// @brief Default check of whether the field has variable length definition
  ///     via @ref comms::option::def::VarLength option.
  /// @return Always @b false.
  static constexpr bool hasVarLength() { return false; }

  /// @brief Default check of whether the field has a consistent value
  ///     for writing.
  /// @return Always @b true.
  static constexpr bool canWrite() { return true; }

  /// @brief Default version update functionality
  /// @details Does nothing and returns false, can be overriden by the
  ///     derived class
  /// @return Always @b false
  static constexpr bool setVersion(VersionType) { return false; }
...
///     composite fields, such as @ref comms::field::Bundle or @ref
...
///     exact type of the @ref comms::field::Bitfield or @ref
///     comms::field::Bundle class.
///     @code
...
///     COMMS_FIELD_MEMBERS_ACCESS_NOTEMPLATE() instead.
/// @see @ref COMMS_FIELD_MEMBERS_NAMES()
...
///     fields, such as @ref comms::field::Bundle or @ref
///     comms::field::Bitfield.
/// @details The fields of "composite" types, such as @ref comms::field::Bundle
/// or
...
///     {
///         // (Re)define base class as inner Base type, required by
///         COMMS_FIELD_MEMBERS_NAMES() using Base =
///         comms::field::Bitfield<...>;
///     public:
...
///         auto field_member2() const ->
///         decltype(std::get<FieldIdx_member3>(value()))
///         {
///             return std::get<FieldIdx_member3>(value());
///         }
///
...
#define COMMS_FIELD_MEMBERS_NAMES(...)                                         \
  ...
  COMMS_EXPAND(COMMS_DO_FIELD_TYPEDEF(typename Base::ValueType, Field_,        \
