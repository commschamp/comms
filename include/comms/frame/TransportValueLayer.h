...
class TransportValueLayer : public comms::frame::details::TransportValueLayerBase<TField, TIdx, TNextLayer, TOptions...>
{
...
protected:
    ...
    /// @deprecated Use @ref comms::frame::TransportValueLayer::reassignFieldValueToMsg() "reassignFieldValueToMsg()"
    ///     instead.
    template <typename TMsg>
