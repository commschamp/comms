...
/// @file
/// @brief Contains definition of @ref comms::frame::checksum::BasicXor
...
/// @details The checksum calculator class that applies XOR operation on all the
/// bytes and
///     returns the result as a checksum value.
/// @tparam TResult Type of the checksum result value.
/// @tparam TInitValue Initial value
/// @headerfile comms/frame/checksum/BasicXor.h
