...
class MsgSizeLayer : public comms::frame::details::MsgSizeLayerBase<TField, TNextLayer, TOptions...>
{
    using BaseImpl = comms::frame::details::MsgSizeLayerBase<TField, TNextLayer, TOptions...>;
...
public:
    ...
    /// @brief Customized update functionality, invoked by @ref update().
    /// @details Similar to other @ref comms::frame::MsgSizeLayer::doUpdate() "doUpdate()",
...
private:
    ...
    using MsgLengthTag =
        typename comms::util::LazyShallowConditional<
            details::FrameLayerHasFieldsImpl<TMsg>::Value || TMsg::hasLength()
        >::template Type<
            MsgHasLengthTag,
            MsgNoLengthTag
        >;
