...
template <typename... TOptions> class FrameLayerBaseOptionsParser;

template <> class FrameLayerBaseOptionsParser<> {
public:
...
template <typename... TOptions>
class FrameLayerBaseOptionsParser<comms::option::app::EmptyOption, TOptions...>
    : public FrameLayerBaseOptionsParser<TOptions...> {};

template <typename... TBundledOptions, typename... TOptions>
class FrameLayerBaseOptionsParser<std::tuple<TBundledOptions...>, TOptions...>
