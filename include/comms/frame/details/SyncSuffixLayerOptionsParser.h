...
template <typename... TOptions> class SyncSuffixLayerOptionsParser;

template <> class SyncSuffixLayerOptionsParser<> {
public:
...
class SyncSuffixLayerOptionsParser<comms::option::def::ExtendingClass<T>,
                                   TOptions...>
    : public SyncSuffixLayerOptionsParser<TOptions...> {
public:
...
template <typename... TOptions>
class SyncSuffixLayerOptionsParser<comms::option::app::EmptyOption, TOptions...>
    : public SyncSuffixLayerOptionsParser<TOptions...> {};

template <typename... TBundledOptions, typename... TOptions>
class SyncSuffixLayerOptionsParser<std::tuple<TBundledOptions...>, TOptions...>
