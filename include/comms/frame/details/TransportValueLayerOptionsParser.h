...
template <typename... TOptions> class TransportValueLayerOptionsParser;

template <> class TransportValueLayerOptionsParser<> {
public:
  ...
  template <typename TBase> using BuildPseudoBase = TBase;

  template <typename TLayer> using DefineExtendingClass = TLayer;

  template <typename TNextLayer>
  using ForceReadUntilDataSplitIfNeeded = typename comms::util::Conditional<
      std::is_void<typename FrameLayerMsgPtr<TNextLayer>::Type>::value>::
      template Type<comms::option::app::EmptyOption,
...
class TransportValueLayerOptionsParser<comms::option::def::PseudoValue,
                                       TOptions...>
...
class TransportValueLayerOptionsParser<comms::option::def::ExtendingClass<T>,
                                       TOptions...>
    : public TransportValueLayerOptionsParser<TOptions...> {
public:
...
template <typename... TOptions>
class TransportValueLayerOptionsParser<comms::option::app::EmptyOption,
                                       TOptions...>
    : public TransportValueLayerOptionsParser<TOptions...> {};

template <typename... TBundledOptions, typename... TOptions>
class TransportValueLayerOptionsParser<std::tuple<TBundledOptions...>,
                                       TOptions...>
