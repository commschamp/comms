...
template <typename... TOptions> class SyncPrefixLayerOptionsParser;

template <> class SyncPrefixLayerOptionsParser<> {
public:
...
class SyncPrefixLayerOptionsParser<comms::option::def::ExtendingClass<T>,
                                   TOptions...>
...
class SyncPrefixLayerOptionsParser<comms::option::app::EmptyOption, TOptions...>
    : public SyncPrefixLayerOptionsParser<TOptions...> {};

template <typename... TBundledOptions, typename... TOptions>
class SyncPrefixLayerOptionsParser<std::tuple<TBundledOptions...>, TOptions...>
