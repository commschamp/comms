...
/// @file
/// @brief Various compile-time detection functions of whether specific member
...
///         "std::string is expected to have clear() member function.");
///     @endcode
template <typename T> constexpr bool hasClearFunc() {
...
///         "std::string is expected to have reserve() member function.");
///     @endcode
template <typename T> constexpr bool hasReserveFunc() {
...
/// @details
///     @code
///         static_assert(comms::util::detect::hasResizeFunc<std::string>(),
///         "std::string is expected to have resize() member function.");
///     @endcode
template <typename T> constexpr bool hasResizeFunc() {
...
///             "comms::util::StringView is expected to have remove_suffix()
///             member function.");
///         static_assert(comms::util::detect::hasRemoveSuffixFunc<std::string_view>,
///             "std::string_view is expected to have remove_suffix() member
///             function.");
///     @endcode
template <typename T> constexpr bool hasRemoveSuffixFunc() {
  return details::HasRemoveSuffixFunc<T>::Value;
}

/// @brief Detect whether provided type has @b assign() member function which
/// can
///     receive two pointers in its arguments
/// @details
///     @code
///         static_assert(comms::util::detect::HasAssignFunc<std::string>(),
///         "std::string is expected to have assign() member function.");
///     @endcode
template <typename T> constexpr bool hasAssignFunc() {
  return details::HasAssignFunc<T>::Value;
}

/// @brief Detect whether provided type has a constructor that receives a
...
///     @endcode
template <typename T> constexpr bool hasPtrSizeConstructor() {
  return details::HasPtrSizeConstructor<T>::Value;
}

/// @brief Detect whether provided type is std::span
template <typename T> constexpr bool isStdSpan() {
...
/// @details
///     @code
///         static_assert(comms::util::detect::hasMaxSizeFunc<std::string>(),
///         "std::string is expected to have max_size() member function.");
///     @endcode
template <typename T> constexpr bool hasMaxSizeFunc() {
