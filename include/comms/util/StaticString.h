...
template <typename TChar> class StaticStringBase {
...
protected:
  ...
  void assign(const StaticStringBase &other) { assign(other, 0, other.size()); }

  void assign(const StaticStringBase &other, std::size_t pos,
              std::size_t count) {
  ...
  void assign(const TChar *str) { assign(str, capacity()); }

  template <typename TIter> void assign(TIter first, TIter last) {
  ...
  TChar &operator[](std::size_t pos) { return m_vec[pos]; }

  const TChar &operator[](std::size_t pos) const { return m_vec[pos]; }
  ...
  TChar *begin() { return m_vec.begin(); }

  const TChar *cbegin() const { return m_vec.cbegin(); }

  TChar *end() { return begin() + size(); }

  const TChar *cend() const { return cbegin() + size(); }
  ...
  std::size_t capacity() const { return m_vec.capacity() - 1; }
  ...
  void insert(std::size_t idx, const StaticStringBase &str, std::size_t str_idx,
              std::size_t count) {
    COMMS_ASSERT(idx <= size());
  ...
  TChar *insert(const TChar *pos, TChar ch) { return m_vec.insert(pos, ch); }
  ...
  TChar *erase(const TChar *pos) { return m_vec.erase(pos, pos + 1); }
  ...
  int compare(std::size_t pos1, std::size_t count1,
              const StaticStringBase &other, std::size_t pos2,
  ...
  int compare(std::size_t pos1, std::size_t count1, const char *str,
              std::size_t count2) const {
    COMMS_ASSERT(pos1 <= size());
    count1 = std::min(count1, size() - pos1);
    auto minCount = std::min(count1, count2);
  ...
  template <typename TIter>
  void replace(const TChar *first, const TChar *last, TIter first2,
               TIter last2) {
  ...
  void replace(const TChar *first, const TChar *last, std::size_t count2,
               TChar ch) {
    COMMS_ASSERT(first <= end());
    COMMS_ASSERT(last <= end());
    COMMS_ASSERT(first <= last);
  ...
  void resize(std::size_t count) { resize(count, Ends); }
  ...
  void swap(StaticStringBase &other) { m_vec.swap(other.m_vec); }
  ...
  std::size_t rfind(const TChar *str, std::size_t pos,
  ...
  std::size_t rfind(TChar ch, std::size_t pos) const {
    ...
    COMMS_ASSERT(static_cast<std::size_t>(std::distance(begIter, endIter)) ==
                 (pos + 1));
  ...
  std::size_t find_first_of(const TChar *str, std::size_t pos,
                            std::size_t count) const {
    if (empty()) {
      return npos;
    }
  ...
  std::size_t find_first_not_of(const TChar *str, std::size_t pos,
                                std::size_t count) const {
    if (empty()) {
      return npos;
    }
    ...
    auto endStr = str + count;
    for (auto iter = cbegin() + pos; iter != cend(); ++iter) {
      auto found = std::none_of(
          str, endStr, [iter](TChar ch) -> bool { return *iter == ch; });
  ...
  std::size_t find_first_not_of(TChar ch, std::size_t pos) const {
    ...
    pos = std::min(pos, size() - 1);
    auto iter =
        std::find_if(cbegin() + pos, cend(),
                     [ch](TChar nextCh) -> bool { return ch != nextCh; });
  ...
  std::size_t find_last_of(const TChar *str, std::size_t pos,
                           std::size_t count) const {
    if (empty()) {
      return npos;
    }
  ...
  std::size_t find_last_not_of(const TChar *str, std::size_t pos,
                               std::size_t count) const {
    if (empty()) {
      return npos;
    }
  ...
  std::size_t find_last_not_of(TChar ch, std::size_t pos) const {
    ...
    auto iter = std::find_if(
        begIter, endIter, [ch](TChar nextCh) -> bool { return ch != nextCh; });
...
private:
  void endString() { m_vec.push_back(TChar(Ends)); }
...
template <typename TChar, std::size_t TSize> struct StaticStringStorageBase {
...
public:
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/basic_string">Reference</a>
  StaticString()
  ...
  StaticString(const StaticString<TOtherSize, TChar> &other, size_type pos,
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/operator%3D">Reference</a>
  StaticString &operator=(const StaticString &other) { return assign(other); }
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/operator%3D">Reference</a>
  StaticString &operator=(const_pointer str) { return assign(str); }

  /// @brief Assignment operator
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/operator%3D">Reference</a>
  StaticString &operator=(value_type ch) { return assign(1, ch); }
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/assign">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/assign">Reference</a>
  template <typename TIter> StaticString &assign(TIter first, TIter last) {
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/at">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/operator_at">Reference</a>
  reference operator[](size_type pos) { return Base::operator[](pos); }
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/front">Reference</a>
  ...
  /// @pre The string mustn't be empty.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/back">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/data">Reference</a>
  const_pointer data() const { return Base::data(); }

  /// @brief Returns a non-modifiable standard C character array version of the
  /// string.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/c_str">Reference</a>
  const_pointer c_str() const { return data(); }

  /// @brief Returns an iterator to the beginning.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/begin">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/end">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/rbegin">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/rend">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/empty">Reference</a>
  bool empty() const { return Base::empty(); }

  /// @brief returns the number of characters.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/size">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/max_size">Reference</a>
  size_type max_size() const { return capacity(); }

  /// @brief Reserves storage.
  /// @details Does nothing for static string.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/reserve">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/capacity">Reference</a>
  size_type capacity() const { return Base::capacity(); }

  /// @brief Reduces memory usage by freeing unused memory.
  /// @details Does nothing for static string.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/shrink_to_fit">Reference</a>
  void shrink_to_fit() {}

  /// @brief Clears the contents.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/clear">Reference</a>
  void clear() { Base::clear(); }

  /// @brief Inserts characters.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/insert">Reference</a>
  ...
  StaticString &insert(size_type idx,
  ...
  StaticString &insert(size_type idx, const StaticString<TAnySize, TChar> &str,
                       size_type str_idx, size_type count = npos) {
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/erase">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/push_back">Reference</a>
  void push_back(value_type ch) { Base::push_back(ch); }

  /// @brief Removes the last character.
  /// @pre The string mustn't be empty.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/pop_back">Reference</a>
  void pop_back() { Base::pop_back(); }

  /// @brief Appends characters to the end.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/append">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/append">Reference</a>
  StaticString &append(const TChar *str) { return insert(size(), str); }

  /// @brief Appends characters to the end.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/append">Reference</a>
  template <typename TIter> StaticString &append(TIter first, TIter last) {
  ...
  /// @brief Appends characters to the end.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/operator%2B%3D">Reference</a>
  template <std::size_t TAnySize>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/operator%2B%3D">Reference</a>
  StaticString &operator+=(value_type ch) { return append(1U, ch); }

  /// @brief Appends characters to the end.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/operator%2B%3D">Reference</a>
  StaticString &operator+=(const_pointer str) { return append(str); }
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/compare">Reference</a>
  template <std::size_t TAnySize>
  ...
  int compare(size_type pos1, size_type count1,
              const StaticString<TAnySize, TChar> &other, size_type pos2,
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/compare">Reference</a>
  int compare(const_pointer str) const { return compare(0, size(), str); }
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/compare">Reference</a>
  int compare(size_type pos, size_type count1, const_pointer str,
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/replace">Reference</a>
  template <std::size_t TAnySize>
  StaticString &replace(size_type pos, size_type count,
  ...
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/replace">Reference</a>
  template <std::size_t TAnySize>
  StaticString &replace(const_iterator first, const_iterator last,
                        const StaticString<TAnySize, TChar> &other) {
  ...
  StaticString &replace(size_type pos, size_type count,
    ...
    auto remCount2 =
        static_cast<std::size_t>(std::distance(begIter2, other.end()));
  ...
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/replace">Reference</a>
  template <typename TIter>
  StaticString &replace(const_iterator first, const_iterator last, TIter first2,
                        TIter last2) {
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/replace">Reference</a>
  StaticString &replace(size_type pos, size_type count, size_type count2,
                        value_type ch) {
    COMMS_ASSERT(pos <= size());
    auto begIter = cbegin() + pos;
    auto endIter = begIter + std::min(count, size() - pos);
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/substr">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/copy">Reference</a>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/resize">Reference</a>
  void resize(size_type count) { Base::resize(count); }

  /// @brief Changes the number of characters stored.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/resize">Reference</a>
  void resize(size_type count, value_type ch) { Base::resize(count, ch); }

  /// @brief Swaps the contents of two strings.
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/swap">Reference</a>
  template <std::size_t TAnySize>
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/find">Reference</a>
  template <std::size_t TAnySize>
  size_type find(const StaticString<TAnySize, TChar> &str,
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/rfind">Reference</a>
  template <std::size_t TAnySize>
  size_type rfind(const StaticString<TAnySize, TChar> &str,
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/find_first_of">Reference</a>
  template <std::size_t TAnySize>
  size_type find_first_of(const StaticString<TAnySize, TChar> &str,
                          size_type pos = 0) const {
    COMMS_ASSERT(pos <= size());
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/find_first_not_of">Reference</a>
  template <std::size_t TAnySize>
  size_type find_first_not_of(const StaticString<TAnySize, TChar> &str,
                              size_type pos = 0) const {
    COMMS_ASSERT(pos <= size());
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/find_last_of">Reference</a>
  template <std::size_t TAnySize>
  size_type find_last_of(const StaticString<TAnySize, TChar> &str,
                         size_type pos = npos) const {
  ...
  /// @see <a
  /// href="http://en.cppreference.com/w/cpp/string/basic_string/find_last_not_of">Reference</a>
  template <std::size_t TAnySize>
  size_type find_last_not_of(const StaticString<TAnySize, TChar> &str,
                             size_type pos = npos) const {
  ...
  bool operator<(const_pointer str) const { return Base::operator<(str); }
...
/// @see <a
/// href="http://en.cppreference.com/w/cpp/string/basic_string/operator_cmp">Reference</a>
...
template <typename T> struct IsStaticString {
...
template <typename T> static constexpr bool isStaticString() {
...
/// @see <a
/// href="http://en.cppreference.com/w/cpp/string/basic_string/swap2">Reference</a>
/// @related comms::util::StaticString
template <std::size_t TSize1, std::size_t TSize2, typename TChar>
