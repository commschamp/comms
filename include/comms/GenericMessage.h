...
using GenericMessageFields =
    std::tuple<comms::field::ArrayList<TFieldBase, std::uint8_t, TExtraOpts>>;
...
///     field as variable length sequence of raw bytes (see @ref
///     GenericMessageFields). The GenericMessage can be useful when
///     implementing some kind of "bridge" or "firewall", that requires
///     knowledge only about message ID and doesn't care much about message
///     contents. The
...
///     @ref comms::option::def::MsgIdType, see @ref
///     page_use_prot_transport_generic_msg)
...
class GenericMessage
    : public comms::MessageBase<
          TMessage,
          comms::option::def::FieldsImpl<
              GenericMessageFields<typename TMessage::Field, TFieldOpts>>,
          comms::option::def::MsgType<
              GenericMessage<TMessage, TFieldOpts, TExtraOpts>>,
          comms::option::def::HasDoGetId, comms::option::def::HasName,
          TExtraOpts> {
  using Base = comms::MessageBase<
      ...
      comms::option::def::MsgType<
          GenericMessage<TMessage, TFieldOpts, TExtraOpts>>,
      comms::option::def::HasDoGetId, comms::option::def::HasName, TExtraOpts>;
