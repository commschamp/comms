...
///     comms::Field.
/// @tparam TEnum Enderlying enum type, can be either unscoped or scoped (enum
/// class).
/// @tparam TOptions Zero or more options that modify/refine default behaviour
///     of the field. If no option is provided, the field's value is serialised
///     as is, where the length of the field is equal to the length of the
///     underlying enum type. For example:
///     @code
...
///     notation because base field class receives comms::option::def::BigEndian
///     option.@n Supported options are:
...
class EnumValue
    : public details::AdaptBasicFieldT<basic::EnumValue<TFieldBase, TEnum>,
                                       TOptions...> {
  using BaseImpl =
      details::AdaptBasicFieldT<basic::EnumValue<TFieldBase, TEnum>,
                                TOptions...>;
...
public:
  ...
  /// @brief Constructor
  explicit EnumValue(const ValueType &val) : BaseImpl(val) {}
...
private:
  ...
  static_assert(!ParsedOptions::HasSequenceFixedSizeUseFixedSizeStorage,
                ...
                "option is not applicable to EnumValue field");
...
/// @related comms::field::EnumValue
template <typename TFieldBase, typename TEnum, typename... TOptions>
inline const EnumValue<TFieldBase, TEnum, TOptions...> &
