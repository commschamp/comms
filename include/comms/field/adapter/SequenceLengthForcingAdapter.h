...
class SequenceLengthForcingAdapter : public TBase
{
...
public:
    ...
    SequenceLengthForcingAdapter() = default;

    explicit SequenceLengthForcingAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit SequenceLengthForcingAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    SequenceLengthForcingAdapter(const SequenceLengthForcingAdapter&) = default;
    SequenceLengthForcingAdapter(SequenceLengthForcingAdapter&&) = default;
    SequenceLengthForcingAdapter& operator=(const SequenceLengthForcingAdapter&) = default;
    SequenceLengthForcingAdapter& operator=(SequenceLengthForcingAdapter&&) = default;
