...
class VarLengthAdapter : public TBase
{
...
public:
    ...
    VarLengthAdapter() = default;

    explicit VarLengthAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit VarLengthAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    VarLengthAdapter(const VarLengthAdapter&) = default;
    VarLengthAdapter(VarLengthAdapter&&) = default;
    VarLengthAdapter& operator=(const VarLengthAdapter&) = default;
    VarLengthAdapter& operator=(VarLengthAdapter&&) = default;
