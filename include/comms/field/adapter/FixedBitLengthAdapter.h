...
class FixedBitLengthAdapter : public TBase
{
...
public:
    ...
    FixedBitLengthAdapter() = default;

    explicit FixedBitLengthAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    FixedBitLengthAdapter(const FixedBitLengthAdapter&) = default;
    FixedBitLengthAdapter(FixedBitLengthAdapter&&) = default;
    FixedBitLengthAdapter& operator=(const FixedBitLengthAdapter&) = default;
    FixedBitLengthAdapter& operator=(FixedBitLengthAdapter&&) = default;
