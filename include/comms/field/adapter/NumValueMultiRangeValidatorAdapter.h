...
class NumValueMultiRangeValidatorAdapter : public TBase
{
...
public:
    ...
    NumValueMultiRangeValidatorAdapter() = default;

    explicit NumValueMultiRangeValidatorAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit NumValueMultiRangeValidatorAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    NumValueMultiRangeValidatorAdapter(const NumValueMultiRangeValidatorAdapter&) = default;
    NumValueMultiRangeValidatorAdapter(NumValueMultiRangeValidatorAdapter&&) = default;
    NumValueMultiRangeValidatorAdapter& operator=(const NumValueMultiRangeValidatorAdapter&) = default;
    NumValueMultiRangeValidatorAdapter& operator=(NumValueMultiRangeValidatorAdapter&&) = default;
