...
template <typename TBase> class IgnoreInvalid : public TBase {
...
public:
  ...
  explicit IgnoreInvalid(const ValueType &val) : BaseImpl(val) {}

  explicit IgnoreInvalid(ValueType &&val) : BaseImpl(std::move(val)) {}
