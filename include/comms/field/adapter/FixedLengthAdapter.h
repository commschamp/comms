...
struct FixedLengthUnsignedValueMaskWrap
{
...
template <>
struct FixedLengthUnsignedValueMaskWrap<sizeof(std::uintmax_t)>
{
...
class FixedLengthAdapter : public TBase
{
...
public:
    ...
    FixedLengthAdapter() = default;

    explicit FixedLengthAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    FixedLengthAdapter(const FixedLengthAdapter&) = default;
    FixedLengthAdapter(FixedLengthAdapter&&) = default;
    FixedLengthAdapter& operator=(const FixedLengthAdapter&) = default;
    FixedLengthAdapter& operator=(FixedLengthAdapter&&) = default;
...
private:
    ...
    static const UnsignedSerialisedType UnsignedValueMask =
        static_cast<UnsignedSerialisedType>(details::FixedLengthUnsignedValueMaskWrap<Length>::Value);
