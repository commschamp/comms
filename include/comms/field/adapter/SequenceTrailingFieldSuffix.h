...
public:
  ...
  explicit SequenceTrailingFieldSuffix(const ValueType &val) : BaseImpl(val) {}
  ...
  operator=(const SequenceTrailingFieldSuffix &) = default;
  SequenceTrailingFieldSuffix &
  operator=(SequenceTrailingFieldSuffix &&) = default;
  ...
  bool valid() const { return m_trailField.valid() && BaseImpl::valid(); }
