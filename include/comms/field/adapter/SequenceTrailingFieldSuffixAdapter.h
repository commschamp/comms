...
class SequenceTrailingFieldSuffixAdapter : public TBase
{
...
public:
    ...
    SequenceTrailingFieldSuffixAdapter() = default;

    explicit SequenceTrailingFieldSuffixAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit SequenceTrailingFieldSuffixAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    SequenceTrailingFieldSuffixAdapter(const SequenceTrailingFieldSuffixAdapter&) = default;
    SequenceTrailingFieldSuffixAdapter(SequenceTrailingFieldSuffixAdapter&&) = default;
    SequenceTrailingFieldSuffixAdapter& operator=(const SequenceTrailingFieldSuffixAdapter&) = default;
    SequenceTrailingFieldSuffixAdapter& operator=(SequenceTrailingFieldSuffixAdapter&&) = default;
