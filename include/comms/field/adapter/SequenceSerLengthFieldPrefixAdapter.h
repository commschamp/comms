...
class SequenceSerLengthFieldPrefixAdapter : public TBase
{
...
public:
    ...
    SequenceSerLengthFieldPrefixAdapter() = default;

    explicit SequenceSerLengthFieldPrefixAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit SequenceSerLengthFieldPrefixAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    SequenceSerLengthFieldPrefixAdapter(const SequenceSerLengthFieldPrefixAdapter&) = default;
    SequenceSerLengthFieldPrefixAdapter(SequenceSerLengthFieldPrefixAdapter&&) = default;
    SequenceSerLengthFieldPrefixAdapter& operator=(const SequenceSerLengthFieldPrefixAdapter&) = default;
    SequenceSerLengthFieldPrefixAdapter& operator=(SequenceSerLengthFieldPrefixAdapter&&) = default;
