...
class AvailableLengthAdapter : public TBase
{
...
public:
    ...
    AvailableLengthAdapter() = default;

    explicit AvailableLengthAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit AvailableLengthAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    AvailableLengthAdapter(const AvailableLengthAdapter&) = default;
    AvailableLengthAdapter(AvailableLengthAdapter&&) = default;
    AvailableLengthAdapter& operator=(const AvailableLengthAdapter&) = default;
    AvailableLengthAdapter& operator=(AvailableLengthAdapter&&) = default;
