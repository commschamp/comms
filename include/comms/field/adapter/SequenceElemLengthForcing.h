...
template <typename TBase> class SequenceElemLengthForcing : public TBase {
...
public:
  ...
  explicit SequenceElemLengthForcing(const ValueType &val) : BaseImpl(val) {}
  ...
  SequenceElemLengthForcing &
  operator=(const SequenceElemLengthForcing &) = default;
  ...
  void clearReadElemLengthForcing() { m_forced = Cleared; }
