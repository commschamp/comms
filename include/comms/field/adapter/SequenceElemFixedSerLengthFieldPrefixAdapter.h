...
class SequenceElemFixedSerLengthFieldPrefixAdapter : public TBase
{
...
public:
    ...
    SequenceElemFixedSerLengthFieldPrefixAdapter() = default;

    explicit SequenceElemFixedSerLengthFieldPrefixAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit SequenceElemFixedSerLengthFieldPrefixAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    SequenceElemFixedSerLengthFieldPrefixAdapter(const SequenceElemFixedSerLengthFieldPrefixAdapter&) = default;
    SequenceElemFixedSerLengthFieldPrefixAdapter(SequenceElemFixedSerLengthFieldPrefixAdapter&&) = default;
    SequenceElemFixedSerLengthFieldPrefixAdapter& operator=(const SequenceElemFixedSerLengthFieldPrefixAdapter&) = default;
    SequenceElemFixedSerLengthFieldPrefixAdapter& operator=(SequenceElemFixedSerLengthFieldPrefixAdapter&&) = default;
    ...
    ErrorStatus write(TIter& iter, std::size_t len) const
    {
        ...
        return basic::BasicCommonFuncs::writeSequence(*this, iter, len);
    }
    ...
    ErrorStatus writeN(std::size_t count, TIter& iter, std::size_t& len) const
    {
        ...
        return basic::BasicCommonFuncs::writeSequenceN(*this, count, iter, len);
    }
...
private:
    ...
    {
        basic::BasicCommonFuncs::advanceWriteIterator(iter, len);
    }
