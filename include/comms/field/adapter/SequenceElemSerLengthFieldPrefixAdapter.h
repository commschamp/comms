...
class SequenceElemSerLengthFieldPrefixAdapter : public TBase
{
...
public:
    ...
    SequenceElemSerLengthFieldPrefixAdapter() = default;

    explicit SequenceElemSerLengthFieldPrefixAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit SequenceElemSerLengthFieldPrefixAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    SequenceElemSerLengthFieldPrefixAdapter(const SequenceElemSerLengthFieldPrefixAdapter&) = default;
    SequenceElemSerLengthFieldPrefixAdapter(SequenceElemSerLengthFieldPrefixAdapter&&) = default;
    SequenceElemSerLengthFieldPrefixAdapter& operator=(const SequenceElemSerLengthFieldPrefixAdapter&) = default;
    SequenceElemSerLengthFieldPrefixAdapter& operator=(SequenceElemSerLengthFieldPrefixAdapter&&) = default;
    ...
    bool canWrite() const
    {
        return basic::BasicCommonFuncs::canWriteSequence(*this);
    }
