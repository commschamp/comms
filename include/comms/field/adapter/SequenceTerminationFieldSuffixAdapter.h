...
class SequenceTerminationFieldSuffixAdapter : public TBase
{
...
public:
    ...
    SequenceTerminationFieldSuffixAdapter() = default;

    explicit SequenceTerminationFieldSuffixAdapter(const ValueType& val)
      : BaseImpl(val)
    {
    }

    explicit SequenceTerminationFieldSuffixAdapter(ValueType&& val)
      : BaseImpl(std::move(val))
    {
    }

    SequenceTerminationFieldSuffixAdapter(const SequenceTerminationFieldSuffixAdapter&) = default;
    SequenceTerminationFieldSuffixAdapter(SequenceTerminationFieldSuffixAdapter&&) = default;
    SequenceTerminationFieldSuffixAdapter& operator=(const SequenceTerminationFieldSuffixAdapter&) = default;
    SequenceTerminationFieldSuffixAdapter& operator=(SequenceTerminationFieldSuffixAdapter&&) = default;
