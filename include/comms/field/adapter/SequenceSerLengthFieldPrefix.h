...
public:
  ...
  explicit SequenceSerLengthFieldPrefix(const ValueType &val) : BaseImpl(val) {}
  ...
  operator=(const SequenceSerLengthFieldPrefix &) = default;
  SequenceSerLengthFieldPrefix &
  operator=(SequenceSerLengthFieldPrefix &&) = default;
