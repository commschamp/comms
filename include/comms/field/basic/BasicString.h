...
struct BasicStringMaxLengthRetrieveHelper
{
    static const std::size_t Value = BasicCommonFuncs::maxSupportedLength();
};

template <std::size_t TSize>
struct BasicStringMaxLengthRetrieveHelper<comms::util::StaticString<TSize> >
{
...
class BasicString : public TFieldBase
{
...
public:
    ...
    explicit BasicString(const ValueType& val)
      : m_value(val)
    {
    }

    explicit BasicString(ValueType&& val)
    ...
    {
        return
            details::BasicStringMaxLengthRetrieveHelper<TStorage>::Value *
            sizeof(ElementType);
    }
