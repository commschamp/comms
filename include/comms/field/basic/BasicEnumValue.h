...
class BasicEnumValue : public TFieldBase
{
    ...
    using IntValueField =
        comms::field::basic::BasicIntValue<
            BaseImpl,
            UnderlyingType
        >;
...
public:
    ...
    explicit BasicEnumValue(ValueType val)
      : m_value(val)
    {
    }

    BasicEnumValue(const BasicEnumValue&) = default;
    BasicEnumValue(BasicEnumValue&&) = default;
    ~BasicEnumValue() noexcept = default;

    BasicEnumValue& operator=(const BasicEnumValue&) = default;
    BasicEnumValue& operator=(BasicEnumValue&&) = default;
