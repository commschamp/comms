...
struct BasicBundleVersionDependencyDetectHelper;

template <typename... TMembers>
struct BasicBundleVersionDependencyDetectHelper<comms::field::details::MembersVersionDependency_NotSpecified, TMembers...>
{
    static constexpr bool Value = BasicCommonFuncs::IsAnyFieldVersionDependentBoolType<TMembers...>::value;
};

template <typename... TMembers>
struct BasicBundleVersionDependencyDetectHelper<comms::field::details::MembersVersionDependency_Independent, TMembers...>
{
    static constexpr bool Value = false;
};

template <typename... TMembers>
struct BasicBundleVersionDependencyDetectHelper<comms::field::details::MembersVersionDependency_Dependent, TMembers...>
{
...
template <typename TFieldBase, comms::field::details::MembersVersionDependency TVersionDependency, typename... TMembers>
class BasicBundle<TFieldBase, TVersionDependency, std::tuple<TMembers...> > : public TFieldBase
{
public:
    ...
    BasicBundle() = default;
    explicit BasicBundle(const ValueType& val)
      : m_members(val)
    {
    }

    explicit BasicBundle(ValueType&& val)
      : m_members(std::move(val))
    {
    }

    BasicBundle(const BasicBundle&) = default;
    BasicBundle(BasicBundle&&) = default;
    ~BasicBundle() noexcept = default;

    BasicBundle& operator=(const BasicBundle&) = default;
    BasicBundle& operator=(BasicBundle&&) = default;
    ...
    {
        return details::BasicBundleVersionDependencyDetectHelper<TVersionDependency, TMembers...>::Value;
    }
