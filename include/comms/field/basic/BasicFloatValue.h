...
class BasicFloatValue : public TFieldBase
{
...
public:
    ...
    BasicFloatValue() = default;

    explicit BasicFloatValue(ValueType val)
      : m_value(val)
    {
    }

    BasicFloatValue(const BasicFloatValue&) = default;
    BasicFloatValue(BasicFloatValue&&) = default;
    ~BasicFloatValue() noexcept = default;

    BasicFloatValue& operator=(const BasicFloatValue&) = default;
    BasicFloatValue& operator=(BasicFloatValue&&) = default;
