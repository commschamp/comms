...
template <typename TFieldBase, typename T> class EnumValue : public TFieldBase {
  ...
  using IntValueField = comms::field::basic::IntValue<BaseImpl, UnderlyingType>;
...
public:
  ...
  explicit EnumValue(ValueType val) : m_value(val) {}
  ...
  static constexpr std::size_t length() { return IntValueField::length(); }
