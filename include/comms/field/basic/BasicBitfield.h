...
class BasicBitfieldReadHelper
{
public:
    BasicBitfieldReadHelper(TSerializedType val, ErrorStatus& es)
      : m_value(val),
        m_es(es)
    {
    }
...
template <typename TSerializedType>
class BasicBitfieldReadNoStatusHelper
{
public:
    BasicBitfieldReadNoStatusHelper(TSerializedType val)
        : m_value(val) {}
...
template <typename TSerializedType>
class BasicBitfieldWriteHelper
{
public:
    BasicBitfieldWriteHelper(TSerializedType& val, ErrorStatus& es)
      : m_value(val),
        m_es(es) {}
...
template <typename TSerializedType>
class BasicBitfieldWriteNoStatusHelper
{
public:
    BasicBitfieldWriteNoStatusHelper(TSerializedType& val)
        : m_value(val) {}
...
struct BasicBitfieldVersionDependencyDetectHelper;

template <typename... TMembers>
struct BasicBitfieldVersionDependencyDetectHelper<comms::field::details::MembersVersionDependency_NotSpecified, TMembers...>
{
    static constexpr bool Value = BasicCommonFuncs::IsAnyFieldVersionDependentBoolType<TMembers...>::value;
};

template <typename... TMembers>
struct BasicBitfieldVersionDependencyDetectHelper<comms::field::details::MembersVersionDependency_Independent, TMembers...>
{
    static constexpr bool Value = false;
};

template <typename... TMembers>
struct BasicBitfieldVersionDependencyDetectHelper<comms::field::details::MembersVersionDependency_Dependent, TMembers...>
{
...
template <typename TFieldBase, comms::field::details::MembersVersionDependency TVersionDependency, typename... TMembers>
class BasicBitfield<TFieldBase, TVersionDependency, std::tuple<TMembers...> > : public TFieldBase
{
    ...
    static const std::size_t TotalBits = BasicCommonFuncs::FieldSumTotalBitLengthIntType<TMembers...>::value;
    static_assert(
...
public:
    ...
    BasicBitfield() = default;
    explicit BasicBitfield(const ValueType& val)
      : m_members(val)
    {
    }

    explicit BasicBitfield(ValueType&& val)
    ...
    ErrorStatus read(TIter& iter, std::size_t size)
    {
        ...
        comms::util::tupleForEachWithTemplateParamIdx(
            m_members, details::BasicBitfieldReadHelper<SerializedType>(serValue, es));
        return es;
    }

    static constexpr bool hasReadNoStatus()
    {
        return BasicCommonFuncs::AllFieldsHaveReadNoStatusBoolType<TMembers...>::value;
    }
    ...
    void readNoStatus(TIter& iter)
    {
        auto serValue = BaseImpl::template readData<SerializedType, Length>(iter);
        comms::util::tupleForEachWithTemplateParamIdx(
            m_members, details::BasicBitfieldReadNoStatusHelper<SerializedType>(serValue));
    }
    ...
    ErrorStatus write(TIter& iter, std::size_t size) const
    {
        ...
        ErrorStatus es = ErrorStatus::Success;
        comms::util::tupleForEachWithTemplateParamIdx(
            m_members, details::BasicBitfieldWriteHelper<SerializedType>(serValue, es));
    ...
    {
        return BasicCommonFuncs::AllFieldsHaveWriteNoStatusBoolType<TMembers...>::value;
    }
    ...
    void writeNoStatus(TIter& iter) const
    {
        SerializedType serValue = 0;
        comms::util::tupleForEachWithTemplateParamIdx(
            m_members, details::BasicBitfieldWriteNoStatusHelper<SerializedType>(serValue));
        comms::util::writeData<Length>(serValue, iter, Endian());
    }
    ...
    {
        return details::BasicBitfieldVersionDependencyDetectHelper<TVersionDependency, TMembers...>::Value;
    }
    ...
    {
        return BasicCommonFuncs::setVersionForMembers(value(), version);
    }
