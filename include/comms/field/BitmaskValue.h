...
///     #COMMS_BITMASK_BITS(). It means that COMMS_BITMASK_BITS_ACCESS()
///     macro can NOT be used without #COMMS_BITMASK_BITS().
///     @code
///     struct MyField : public comms::field::BitmaskValue<...>
///     {
...
///     }
///     @endcode
/// @pre Must be used together with #COMMS_BITMASK_BITS()
...
///     #COMMS_BITMASK_BITS_ACCESS_NOTEMPLATE() macro instead. In
...
///     template one, please use #COMMS_BITMASK_BITS_ACCESS_NOTEMPLATE()
///     instead.
...
///     #COMMS_BITMASK_BITS() and #COMMS_BITMASK_BITS_ACCESS() with the
...
///     type of the base class. If the compilation fails,
///     and this macro resides inside a @b NON-template class, please use
///     #COMMS_BITMASK_BITS_SEQ_NOTEMPLATE() macro instead. In
///     case this macro needs to reside inside a @b template class, then
///     there is a need to define inner @b Base type, which specifies
///     exact type of the @ref comms::field::BitmaskValue class. For example:
///     @code
...
///     to compile it even though it uses valid C++11 constructs. If the
///     compilation fails and the class it is being used in is @b NOT a
///     template one, please use #COMMS_BITMASK_BITS_SEQ_NOTEMPLATE()
///     instead.
/// @note Defined in "comms/field/BitmaskValue.h"
