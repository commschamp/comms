...
///     ... bits.
///
///     Refer to @ref sec_field_tutorial_bitfield for tutorial and usage
///     examples.
...
public:
  ...
  /// @details All field members are initialised using their default
  /// constructors.
  Bitfield() = default;

  /// @brief Constructor
  /// @param[in] val Value of the field to initialise it with.
  explicit Bitfield(const ValueType &val) : BaseImpl(val) {}

  /// @brief Constructor
  /// @param[in] val Value of the field to initialise it with.
  explicit Bitfield(ValueType &&val) : BaseImpl(std::move(val)) {}
  ...
  /// @return Number of bits, specified with @ref
  /// comms::option::def::FixedBitLength option
...
private:
  ...
  static_assert(!ParsedOptions::HasSequenceElemLengthForcing,
                ...
                "is not applicable to Bitfield field");
  ...
  static_assert(!ParsedOptions::HasSequenceLengthForcing,
                "comms::option::def::SequenceLengthorcingEnabled option is not "
                "applicable to Bitfield field");
  ...
  static_assert(!ParsedOptions::HasSequenceFixedSizeUseFixedSizeStorage,
                ...
                "option is not applicable to Bitfield field");
  ...
  static_assert(!ParsedOptions::HasSequenceSerLengthFieldPrefix,
                ...
                "not applicable to Bitfield field");
