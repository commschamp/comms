...
///     comms::Field.
/// @tparam T Basic underlying floating point type, must be either float or
/// double.
...
class FloatValue
    : public details::AdaptBasicFieldT<basic::FloatValue<TFieldBase, T>,
                                       TOptions...> {
  using BaseImpl =
      details::AdaptBasicFieldT<basic::FloatValue<TFieldBase, T>, TOptions...>;
...
public:
  ...
  /// @brief Constructor
  explicit FloatValue(const ValueType &val) : BaseImpl(val) {}
...
private:
  ...
  static_assert(!ParsedOptions::HasSequenceLengthForcing,
                ...
                "not applicable to FloatValue field");
  ...
  static_assert(!ParsedOptions::HasSequenceFixedSizeUseFixedSizeStorage,
                ...
                "option is not applicable to FloatValue field");
...
/// @related FloatValue
template <typename TFieldBase, typename T, typename... TOptions>
bool operator==(const FloatValue<TFieldBase, T, TOptions...> &field1,
...
/// @related comms::field::FloatValue
template <typename TFieldBase, typename T, typename... TOptions>
inline const FloatValue<TFieldBase, T, TOptions...> &
